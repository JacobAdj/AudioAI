...
def parse_args():
    ...
    parser.add_argument(
        "--model_dir",
        type=str,
        default="D:/LanguageModels/sparktts",
    ...
    parser.add_argument(
        "--save_dir",
        type=str,
        default="D:/LanguageModels/sparktts/results",
        help="Directory to save generated audio files",
    )

    parser.add_argument(
        "--device", type=int, default=0, help="CUDA device number"
    )
...
def run_tts(args):
    ...
    print('args.model_dir' , args.model_dir, 'device' , device)
